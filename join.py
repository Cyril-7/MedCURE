from undetected_chromedriver.v2 import webdriver
...
mail_address = 'anandsuresh2004@gmail.com'
password = 'sachintendulkar4'
...
# go to google meet
driver.get('https://meet.google.com/vtc-yteo-xpq')
turnOffMicCam()
# AskToJoin()
joinNow()