$(window).on("load", function () {
  ...
  $(".edit-ride").on("click", function () {
    if (
      $(".ride.selected").hasClass("maintenance") ||
      $(".ride.selected").hasClass("preparation") ||
      $(".ride.selected").hasClass("return") ||
      $(".ride.selected").hasClass("service")
    ) {
  ...
  $("#select-driver").submit(function () {
    ...
    let selectedDriver = $(
      ".driver-selector tr.selected td.console-driver"
    ).text();
    let driverImage = $(
      ".driver-selector tr.selected td.console-driver-img img"
    ).attr("src");
